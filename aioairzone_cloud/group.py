...
class Group:
    ...
    def __init__(self, inst_id: str, group_data: dict[str, Any]):
    ...
    def get_available(self) -> bool:
        """Return Group availability status."""
        for aidoo in self.aidoos.values():
    ...
    def get_temp_step(self) -> float | None:
        """Return Group temperature step."""
        return API_DEFAULT_TEMP_STEP

    def set_params(self, params: dict[str, Any]) -> None:
        """Update Group parameters from API request."""
