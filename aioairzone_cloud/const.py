...
API_CONFIG_TYPE_ADVANCED: Final[str] = "advanced"
...
AZD_CONSUMPTION_UE: Final[str] = "consumption-ue"
AZD_DISCH_COMP_TEMP_UE: Final[str] = "disch-comp-temp-ue"
AZD_DISCONNECTION_DATE: Final[str] = "disconnection-date"
AZD_ERRORS: Final[str] = "errors"
AZD_EXCH_HEAT_TEMP_IU: Final[str] = "exch-heat-temp-iu"
AZD_EXCH_HEAT_TEMP_UE: Final[str] = "exch-heat-temp-ue"
AZD_EXTERNAL_TEMP: Final[str] = "external-temperature"
...
AZD_PE_UE: Final[str] = "pe-ue"
AZD_POWER: Final[str] = "power"
AZD_PROBLEMS: Final[str] = "problems"
AZD_RETURN_TEMP: Final[str] = "return-temp"
...
AZD_WORK_TEMP: Final[str] = "work-temp"
