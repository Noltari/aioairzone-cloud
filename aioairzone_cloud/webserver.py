    ...
    def update_data(self, update: EntityUpdate) -> None:
        ...
        if ws_config is not None:
            ...
            if stat_ap_mac is not None:
                self.wifi_mac = parse_str(stat_ap_mac)
